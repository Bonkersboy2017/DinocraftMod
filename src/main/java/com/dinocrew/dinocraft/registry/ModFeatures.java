...
public class ModFeatures {
    ...
    public static void registerAll() {
        ...
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, Dinocraft.id("overworld_skeleton_ore")));
        ...
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, Dinocraft.id("overworld_bronzium_ore")));
        ...
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, Dinocraft.id("overworld_fossilised_stone")));

        Registry.register(BuiltinRegistries.PLACED_FEATURE, Dinocraft.id("overworld_amber_ore"), OVERWORLD_AMBER_ORE_PLACED_FEATURE);
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, Dinocraft.id("overworld_amber_ore")));
    }
}