...
public class ModItems {
    ...
    public static Item SHARD_OF_ENLIGHTENMENT = new Item(new FabricItemSettings().group(Dinocraft.ITEM_GROUP).rarity(Rarity.EPIC));
    public static Item TROPICAL_BERRIES = new Item(new FabricItemSettings().group(Dinocraft.ITEM_GROUP).food(ModFoodComponents.TROPICAL_BERRIES));
    public static Item ENLIGHTENED_CORE = new Item(new FabricItemSettings().group(Dinocraft.ITEM_GROUP).rarity(Rarity.EPIC));
    public static Item ENLIGHTENED_NECKLACE = new Item(new FabricItemSettings().group(Dinocraft.ITEM_GROUP).rarity(Rarity.EPIC));
    public static Item DRAGONWOOD_BOAT = new DragonwoodBoatItem(new FabricItemSettings().group(Dinocraft.ITEM_GROUP));
    public static Item EMPTY_DNA_BOTTLE = new Item(new FabricItemSettings().group(Dinocraft.ITEM_GROUP));
    public static Item DNA_BOTTLE = new Item(new FabricItemSettings().group(Dinocraft.ITEM_GROUP));
    public static Item MYSTERIOUS_DNA_BOTTLE = new Item(new FabricItemSettings().group(Dinocraft.ITEM_GROUP));
    public static Item INFLAMED_DNA_BOTTLE = new Item(new FabricItemSettings().group(Dinocraft.ITEM_GROUP));
