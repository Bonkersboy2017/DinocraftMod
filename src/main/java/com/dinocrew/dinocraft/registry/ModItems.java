...
public class ModItems {
    ...
    public static final Item ALLOSAURUS_SKULL = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP).rarity(Rarity.UNCOMMON));
    public static final Item BARYONYX_SKULL = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP).rarity(Rarity.UNCOMMON));
    public static final Item CARNOTAURUS_SKULL = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP).rarity(Rarity.UNCOMMON));
    public static final Item DINO_KIDNEY = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item BERRIES = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP).food(ModFoodComponents.BERRIES));
    public static final Item INFECTED_BERRIES = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP).food(ModFoodComponents.INFECTED_BERRIES));
    public static final Item DINO_SKELETON_JAW = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item RAW_DINO_FLESH = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item DINO_FLESH = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP).food(ModFoodComponents.DINO_FLESH));
    public static final Item PILL = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item FOSSIL = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    ...
    public static final Item CYAD_SEEDS = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP).food(ModFoodComponents.CYAD_SEEDS));
    public static final Item ROTTING_CYADS = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP).food(ModFoodComponents.ROTTING_CYADS));
    public static final Item CYAD_LEAF = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP).food(ModFoodComponents.CYAD_LEAF));
    public static final Item BRONZIUM_INGOT = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    //public static final Item THEM_CHILLI = new Item(new QuiltItemSettings()().group(Dinocraft.ITEM_GROUP));
    //public static final Item DEMME_BERRIES = new Item(new QuiltItemSettings()().group(Dinocraft.ITEM_GROUP));
    public static final Item TIME_FLINT = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item WYVERN_CRYSTAL = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item SAUROPOD_SPAWN_EGG = new SpawnEggItem(ModEntities.SAUROPOD, 25600, 9498256, new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item THEROPOD_SPAWN_EGG = new SpawnEggItem(ModEntities.THEROPOD, 0xff8c00, 16777215, new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item TROODON_SPAWN_EGG = new SpawnEggItem(ModEntities.TROODON, 0x5c4033, 16753920, new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item MICORAPTOR_SPAWN_EGG = new SpawnEggItem(ModEntities.MICRORAPTOR, 16753920, 132957, new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item MOSASAURUS_SPAWN_EGG = new SpawnEggItem(ModEntities.MOSASAURUS, 11393254, 9498256, new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item CHINLEA_SPAWN_EGG = new SpawnEggItem(ModEntities.CHINLEA, 144238144, 0xFFFFFF, new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item STEGORAPTOR_SPAWN_EGG = new SpawnEggItem(ModEntities.STEGORAPTOR, 25600, 139, new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item DEINONYCHUS_SPAWN_EGG = new SpawnEggItem(ModEntities.DEINONYCHUS, 167475200, 16753920, new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item PROFESSOR_SPAWN_EGG = new SpawnEggItem(ModEntities.PROFESSOR, 0xFFFFFF, 0x808080, new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item SCORPIUS_SPAWN_EGG = new SpawnEggItem(ModEntities.SCORPIUS, 0x808080, 0xFFFF00, new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item TREX_SPAWN_EGG = new SpawnEggItem(ModEntities.TREX, 0xC8AE7E, 0xD1C0A8, new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item DINOSTEEL_INGOT = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item SHARD_OF_ENLIGHTENMENT = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP).rarity(Rarity.EPIC));
    public static final Item TROPICAL_BERRIES = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP).food(ModFoodComponents.TROPICAL_BERRIES));
    public static final Item ENLIGHTENED_CORE = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP).rarity(Rarity.EPIC));
    public static final Item ENLIGHTENED_NECKLACE = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP).rarity(Rarity.EPIC));
    public static final Item DRAGONWOOD_BOAT = new BoatItem(false, DinoBoats.DRAGONWOOD, new QuiltItemSettings().maxCount(1).group(Dinocraft.ITEM_GROUP));
    public static final Item DRAGONWOOD_CHEST_BOAT = new BoatItem(true, DinoBoats.DRAGONWOOD, new QuiltItemSettings().maxCount(1).group(Dinocraft.ITEM_GROUP));
    public static final Item DRAGONWOOD_SIGN = new SignItem(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP).maxCount(16),
            ModBlocks.DRAGONWOOD_SIGN_BLOCK, ModBlocks.DRAGONWOOD_WALL_SIGN_BLOCK);
    public static final Item EMPTY_DNA_BOTTLE = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item DNA_BOTTLE = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item MYSTERIOUS_DNA_BOTTLE = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item INFLAMED_DNA_BOTTLE = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item DINO_FEATHER = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item AMBER_GEM = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
    public static final Item DRAGONWOOD_SCRAP = new Item(new QuiltItemSettings().group(Dinocraft.ITEM_GROUP));
