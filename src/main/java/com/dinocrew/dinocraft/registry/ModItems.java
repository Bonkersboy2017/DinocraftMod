...
public class ModItems {
    ...
    public static final Item TREX_SPAWN_EGG = new SpawnEggItem(ModEntities.TREX, 0xBFAA8C, 0xD1C0A8, new Item.Settings().group(Dinocraft.ITEM_GROUP));
    ...
    public static void registerAll() {
        ...
        Registry.register(Registry.ITEM, new Identifier(Dinocraft.MOD_ID, "trex_spawn_egg"), TREX_SPAWN_EGG);
