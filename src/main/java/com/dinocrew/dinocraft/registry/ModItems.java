...
public class ModItems {
    ...
    public static final Item BERRIES = new Item(new FabricItemSettings().tab(Dinocraft.ITEM_GROUP).food(ModFoodComponents.BERRIES));
    public static final Item INFECTED_BERRIES = new Item(new FabricItemSettings().tab(Dinocraft.ITEM_GROUP).food(ModFoodComponents.INFECTED_BERRIES));
    ...
    public static final Item DINO_FLESH = new Item(new FabricItemSettings().tab(Dinocraft.ITEM_GROUP).food(ModFoodComponents.DINO_FLESH));
    ...
    public static final Item CYAD_SEEDS = new Item(new FabricItemSettings().tab(Dinocraft.ITEM_GROUP).food(ModFoodComponents.CYAD_SEEDS));
    public static final Item ROTTING_CYADS = new Item(new FabricItemSettings().tab(Dinocraft.ITEM_GROUP).food(ModFoodComponents.ROTTING_CYADS));
    public static final Item CYAD_LEAF = new Item(new FabricItemSettings().tab(Dinocraft.ITEM_GROUP).food(ModFoodComponents.CYAD_LEAF));
    ...
    public static final Item SAUROPOD_SPAWN_EGG = new SpawnEggItem(ModEntities.SAUROPOD, 25600, 9498256, new FabricItemSettings().tab(Dinocraft.ITEM_GROUP));
    public static final Item THEROPOD_SPAWN_EGG = new SpawnEggItem(ModEntities.THEROPOD, 0xff8c00, 16777215, new FabricItemSettings().tab(Dinocraft.ITEM_GROUP));
    public static final Item TROODON_SPAWN_EGG = new SpawnEggItem(ModEntities.TROODON, 0x5c4033, 16753920, new FabricItemSettings().tab(Dinocraft.ITEM_GROUP));
    public static final Item MICORAPTOR_SPAWN_EGG = new SpawnEggItem(ModEntities.MICRORAPTOR, 16753920, 132957, new FabricItemSettings().tab(Dinocraft.ITEM_GROUP));
    public static final Item MOSASAURUS_SPAWN_EGG = new SpawnEggItem(ModEntities.MOSASAURUS, 11393254, 9498256, new FabricItemSettings().tab(Dinocraft.ITEM_GROUP));
    public static final Item CHINLEA_SPAWN_EGG = new SpawnEggItem(ModEntities.CHINLEA, 144238144, 0xFFFFFF, new FabricItemSettings().tab(Dinocraft.ITEM_GROUP));
    public static final Item STEGORAPTOR_SPAWN_EGG = new SpawnEggItem(ModEntities.STEGORAPTOR, 25600, 139, new FabricItemSettings().tab(Dinocraft.ITEM_GROUP));
