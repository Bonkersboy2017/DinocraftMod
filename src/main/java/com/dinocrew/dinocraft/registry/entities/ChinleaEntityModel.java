...
public class ChinleaEntityModel extends HierarchicalModel<ChinleaEntity> {
    ...
    @Override
    public void setupAnim(ChinleaEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
