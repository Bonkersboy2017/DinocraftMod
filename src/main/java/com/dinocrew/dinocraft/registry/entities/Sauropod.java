...
public class Sauropod extends TamableAnimal {
    public Sauropod(EntityType<? extends TamableAnimal> entityType, Level world) {
...
//        this.targetSelector.add(2, new IndoraptorEntity.TargetGoal(this, PlayerEntity.class));
    ...
    public static boolean canSpawn(EntityType<Sauropod> type, LevelAccessor level, MobSpawnType reason, BlockPos pos, RandomSource random) {
        return true;
    }
