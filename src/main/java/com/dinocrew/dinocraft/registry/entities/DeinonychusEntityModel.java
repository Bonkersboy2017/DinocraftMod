...
public class DeinonychusEntityModel extends HierarchicalModel<DeinonychusEntity> {
    ...
    @Override
    public void setupAnim(DeinonychusEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
