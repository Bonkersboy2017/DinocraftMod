...
public class DragonwoodBoatEntityModel extends CompositeEntityModel<DragonwoodBoatEntity> {
    ...
    public DragonwoodBoatEntityModel(ModelPart root) {
    ...
    public void setAngles(DragonwoodBoatEntity boatEntity, float f, float g, float h, float i, float j) {
