...
public class DragonwoodBoatEntity extends Entity {
    ...
    private DragonwoodBoatEntity.Location location;
    private DragonwoodBoatEntity.Location lastLocation;
    ...
    public Item asItem() {
        return ModItems.DRAGONWOOD_BOAT;
    }
    ...
    public void tick() {
        ...
        if (this.location != DragonwoodBoatEntity.Location.UNDER_WATER && this.location != DragonwoodBoatEntity.Location.UNDER_FLOWING_WATER) {
    ...
    private DragonwoodBoatEntity.Location checkLocation() {
        DragonwoodBoatEntity.Location location = this.getUnderWaterLocation();
        if (location != null) {
            this.waterLevel = this.getBoundingBox().maxY;
            return location;
        } else if (this.checkBoatInWater()) {
            return DragonwoodBoatEntity.Location.IN_WATER;
        } else {
            float f = this.method_7548();
            if (f > 0.0F) {
                this.field_7714 = f;
                return DragonwoodBoatEntity.Location.ON_LAND;
            } else {
                return DragonwoodBoatEntity.Location.IN_AIR;
            }
        }
    }
    ...
    @Nullable
    private DragonwoodBoatEntity.Location getUnderWaterLocation() {
        Box box = this.getBoundingBox();
        ...
        return bl ? DragonwoodBoatEntity.Location.UNDER_WATER : null;
    }
    ...
    private void updateVelocity() {
        ...
        if (this.lastLocation == DragonwoodBoatEntity.Location.IN_AIR && this.location != DragonwoodBoatEntity.Location.IN_AIR && this.location != DragonwoodBoatEntity.Location.ON_LAND) {
            ...
            if (this.location == DragonwoodBoatEntity.Location.IN_WATER) {
                ...
                e = -7.0E-4D;
                this.velocityDecay = 0.9F;
            } else if (this.location == DragonwoodBoatEntity.Location.UNDER_WATER) {
                f = 0.009999999776482582D;
                this.velocityDecay = 0.45F;
            } else if (this.location == DragonwoodBoatEntity.Location.IN_AIR) {
                this.velocityDecay = 0.9F;
            } else if (this.location == DragonwoodBoatEntity.Location.ON_LAND) {
        ...
        if (!this.hasVehicle()) {
            if (onGround) {
                if (this.fallDistance > 3.0F) {
                    if (this.location != DragonwoodBoatEntity.Location.ON_LAND) {
    ...
    public boolean isSubmergedInWater() {
        return this.location == DragonwoodBoatEntity.Location.UNDER_WATER || this.location == DragonwoodBoatEntity.Location.UNDER_FLOWING_WATER;
    }
