...
public class TRexEntityModel extends EntityModel<TRexEntity> implements AnimationAPI {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData modelPartData4 = modelPartData.addChild("bb_main", ModelPartBuilder.create().uv(70, 104).cuboid(-7.0F, -37.0F, -32.0F, 14.0F, 15.0F, 22.0F).uv(0, 44).cuboid(-9.0F, -37.0F, 21.0F, 18.0F, 16.0F, 25.0F).uv(0, 104).cuboid(0.0F, -45.0F, 21.0F, 0.0F, 8.0F, 25.0F), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
