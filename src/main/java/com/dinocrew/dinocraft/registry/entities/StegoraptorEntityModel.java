...
import com.dinocrew.dinocraft.registry.entities.StegoraptorEntity;
...
this.nose = this.head.getChild("nose");
	...
	public StegoraptorEntityModel(ModelPart body, ModelPart neck1, ModelPart neck2, ModelPart head, ModelPart nose, ModelPart jaw, ModelPart right_hip, ModelPart right_leg, ModelPart right_knee, ModelPart right_foot, ModelPart left_hip, ModelPart left_leg, ModelPart left_knee, ModelPart left_foot, ModelPart right_arm, ModelPart right_wrist, ModelPart right_hand, ModelPart left_arm, ModelPart left_wrist, ModelPart left_hand, ModelPart tail1, ModelPart tail2, ModelPart tail3) {
		this.body = body;
		this.neck1 = neck1;
		this.neck2 = neck2;
		this.head = head;
...
ModelPartData modelPartData5 = modelPartData1.addChild("right_hip", ModelPartBuilder.create().uv(30,56).cuboid(-3.0F, -3.0F, -5.0F, 6.0F, 12.0F, 10.0F, true), ModelTransform.pivot(-4.5F,1.5F,6.5F));
...
ModelPartData modelPartData7 = modelPartData6.addChild("right_knee", ModelPartBuilder.create().uv(0,46).cuboid(-2.0F, -1.0F, -2.0F, 4.0F, 11.0F, 4.0F, true), ModelTransform.pivot(0.0F,4.5F,-1.5F));
...
ModelPartData modelPartData8 = modelPartData1.addChild("left_hip", ModelPartBuilder.create().uv(30,56).cuboid(-3.0F, -3.0F, -5.0F, 6.0F, 12.0F, 10.0F), ModelTransform.pivot(4.5F,1.5F,6.5F));
...
ModelPartData modelPartData10 = modelPartData9.addChild("left_knee", ModelPartBuilder.create().uv(0,46).cuboid(-2.0F, -1.0F, -2.0F, 4.0F, 11.0F, 4.0F), ModelTransform.pivot(0.0F,4.5F,-1.5F));
...
ModelPartData modelPartData11 = modelPartData1.addChild("right_arm", ModelPartBuilder.create().uv(0,0).cuboid(-2.5F, -1.0F, -2.5F, 4.0F, 10.0F, 5.0F), ModelTransform.pivot(-4.5F,-2.0F,-6.5F));
ModelPartData modelPartData12 = modelPartData11.addChild("right_wrist", ModelPartBuilder.create().uv(26,84).cuboid(-1.5F, -0.75F, -2.0F, 3.0F, 10.0F, 4.0F), ModelTransform.pivot(-0.5F,8.25F,0.0F));
...
ModelPartData modelPartData13 = modelPartData1.addChild("left_arm", ModelPartBuilder.create().uv(0,0).cuboid(-1.5F, -1.0F, -2.5F, 4.0F, 10.0F, 5.0F, true), ModelTransform.pivot(4.5F,-2.0F,-6.5F));
ModelPartData modelPartData14 = modelPartData13.addChild("left_wrist", ModelPartBuilder.create().uv(26,84).cuboid(-1.5F, -0.75F, -2.0F, 3.0F, 10.0F, 4.0F, true), ModelTransform.pivot(0.5F,8.25F,0.0F));
...
ModelPartData modelPartData16 = modelPartData15.addChild("tail2", ModelPartBuilder.create().uv(42,0).cuboid(-3.0F, 0.0F, 0.0F, 6.0F, 6.0F, 12.0F).uv(30,66).cuboid(0.0F, -6.0F, 0.0F, 0.0F, 6.0F, 12.0F), ModelTransform.pivot(0.0F,-2.0F,12.0F));
modelPartData16.addChild("tail3", ModelPartBuilder.create().uv(0,46).cuboid(-2.0F, 0.0F, 0.0F, 4.0F, 3.0F, 16.0F).uv(54,26).cuboid(0.0F, -6.0F, 0.0F, 0.0F, 6.0F, 12.0F), ModelTransform.pivot(0.0F,2.0F,12.0F));
